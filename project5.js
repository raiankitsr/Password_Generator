...
const lengthno  = document.querySelector('.lengthno');
...
function handleSlider() {
    ...
    lengthno.innerText = passwordLength;
...
function generatePassword(){
    ...
    if(uppercase.checked) checkedCbArray.push(generateUppercase);
    if(lowercase.checked) checkedCbArray.push(generateLowercase);
    if(number.checked) checkedCbArray.push(generateNumber);
    if(symbol.checked) checkedCbArray.push(generateSymbol);
...
generatebuttonz.addEventListener('click', generatePassword);